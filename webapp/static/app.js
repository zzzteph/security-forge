...
createApp({
  ...
  methods: {
    ...
    applyRoute() {
      ...
      const views = ['dashboard', 'repos', 'findings', 'reports', 'scans', 'skills', 'backends', 'settings'];
    ...
    <div v-if="view=='dashboard'">
      ...
      <div class="card">
        ...
        <table><thead><tr>
          ...
          <th @click="toggleSort('dash','last_seen')" style="cursor:pointer">Updated{{caret('dash','last_seen')}}</th></tr></thead>
...
<div v-if="scanView" class="modal-bg"><div class="modal" style="width:min(900px,96vw)">
  ...
  <div v-if="scanView.findings && scanView.findings.length">
    ...
    <table><thead><tr><th>Sev</th><th>Title</th><th>Status</th></tr></thead>
